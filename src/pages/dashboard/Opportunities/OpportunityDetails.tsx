...
const OpportunityDetails = () => {
  ...
  const { queryData: opportunityData, handleDataUpdate } = Query(
    queries.opportunity
  );
  ...
  return (
    <InnerPageContainer
      ...
      <CustomModal
        ...
        <p className='text-gray-600'>
          Are you sure you want to publish this opportunity? It will be visible
          to all users.
        </p>
      </CustomModal>
      ...
      <CustomModal
        ...
        <p className='text-gray-600'>
          Are you sure you want to unpublish this opportunity? It will no longer
          be visible to users.
        </p>
      </CustomModal>
    </InnerPageContainer>
